...
// Creates the APDU for a Full Table Read Request
//
// Format: <command><tableId>
//
int ctFullReadRequest(uint8_t* buffer, uint16_t table_id);

// Creates the APDU for a Full Table Write Request
//
...
// Creates the APDU for a Partial Table Read Request
//
...
// Creates the APDU for a Partial Table Write Request
//
...
// Creates the APDU for a Full/Partial Table Read Response
//
...
// Creates the APDU for a Full/Partial Table Write Response
//
// Format: <response>
//
